...
export const GATHERING: Record<ResourceNode['kind'], GatherRule> = {
  ...
  stone: { itemId: 'stone', amount: 14, preferredTool: 'pickaxe', toolMultiplier: 1, weakSpotMultiplier:1.5, toolYield:{rock:14,hatchet:7,pickaxe:34}, label: 'Stone' },
  metal: { itemId: 'ore', amount: 8, preferredTool: 'pickaxe', toolMultiplier: 1, weakSpotMultiplier:1.5, toolYield:{rock:8,hatchet:4,pickaxe:22}, label: 'Metal Ore' },
  sulfur: { itemId: 'sulfurOre', amount: 7, preferredTool: 'pickaxe', toolMultiplier: 1, weakSpotMultiplier:1.5, toolYield:{rock:6,hatchet:3,pickaxe:20}, label: 'Sulfur Ore' },
  hqmetal: { itemId: 'hqMetalOre', amount: 3, preferredTool: 'pickaxe', toolMultiplier: 1, weakSpotMultiplier:1.5, toolYield:{rock:2,hatchet:1,pickaxe:8}, label: 'High Quality Metal Ore' },
