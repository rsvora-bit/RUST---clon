...
export const RECIPES: Record<string, RecipeDefinition> = {
  workshop_pickaxe:{id:'workshop_pickaxe',resultItemId:'pickaxe',resultCount:1,ingredients:{wood:40,metal:15},requiredWorkbenchLevel:1,requiredTech:'efficiencyTooling',category:'Tools',craftTime:2},
  workshop_dressings:{id:'workshop_dressings',resultItemId:'bandage',resultCount:5,ingredients:{fiber:60},requiredWorkbenchLevel:2,requiredTech:'fieldMedicine',category:'Survival',craftTime:4},
  workshop_lights:{id:'workshop_lights',resultItemId:'torch',resultCount:3,ingredients:{wood:50,fiber:15},requiredWorkbenchLevel:3,requiredTech:'workshopLighting',category:'Tools',craftTime:3},
  ...
  reinforced_storage:{id:'reinforced_storage',resultItemId:'storage',resultCount:1,ingredients:{wood:240,metal:50},requiredWorkbenchLevel:2,requiredTech:'advancedFabrication',category:'Building',craftTime:5},
