...
export const ITEMS: Record<ItemId, ItemDefinition> = {
  ...
  scrap: item('scrap', 'Scrap', 'Sorted salvage with enough value to support advanced island progression.', 'resource', 1000, ['scrap','progression','salvage'], {placeable:false}),
  gears: item('gears', 'Gears', 'Recovered mechanical gearing from abandoned equipment.', 'resource', 100, ['component','salvage'], {placeable:false}),
  wiring: item('wiring', 'Wiring', 'Insulated electrical wiring salvaged from old equipment.', 'resource', 100, ['component','salvage'], {placeable:false}),
  machineParts: item('machineParts', 'Machine Parts', 'Precision mechanical pieces useful for advanced fabrication.', 'resource', 100, ['component','salvage'], {placeable:false}),
  techParts: item('techParts', 'Tech Parts', 'Rare sealed technical modules recovered from high-value salvage.', 'resource', 50, ['component','salvage'], {placeable:false}),
